	    ...
	    Bloom.prototype = {
	        draw: function () {
                ...
                this.garden.ctx.arc(0, 0, this.r / 4, 0, 2 * Math.PI, false);
                this.garden.ctx.fillStyle = 'yellow';
	    ...
	    Garden.prototype = {
	        ...
	        createRandomBloom: function (x, y) {
	            this.createBloom(x, y, Garden.randomInt(Garden.options.bloomRadius.min, Garden.options.bloomRadius.max), Garden.rgba(255, 255, 255, Garden.options.color.opacity), Garden.randomInt(Garden.options.petalCount.min, Garden.options.petalCount.max));
	        },
